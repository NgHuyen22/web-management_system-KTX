                 ...
                 <div class="card"> 
                    <form action="" class="box box-login" method="POST"> 
                        @csrf
                            ...
                            <input type="text" name="mscb" placeholder="Mã số đăng nhập" value="{{session('remember_mscb') }}"> 
                                <div class="error_username" style="color: red;"> 
                                    @error('mscb') 
                                            <small> Vui lòng nhập mã số !</small>
                                    @enderror
                                </div>
                            <input type="password" name="pass" id="pass" placeholder="Mật khẩu" value="{{ session('remember_pass') }}"> 
                                <div class="error_username" style="color: red;"> 
                                    @error('pass') 
